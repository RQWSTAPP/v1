    ...
    return Container(
      ...
      child: Row(children: [
        Expanded(child: _ModeBtn(
          label: context.read<dynamic>()?.t('requesterMode') ?? 'Requester',
          active: !isProvider,
          activeColor: RqwstColors.brand,
          onTap: onRequester,
        )),
        Expanded(child: _ModeBtn(
          label: context.read<dynamic>()?.t('providerMode') ?? 'Provider',
          active: isProvider,
...
extension ReadContext on BuildContext {
  T read<T>() => this as T; // replaced with proper provider access in screens
}
